...
public class Constants {
    ...
    //public final static String STORE_PATH = System.getProperty("store.path", "/home/lee/tmp");
    ...
    public final static int PRO_MAX = Integer.valueOf(System.getProperty("pro.max","10000000")); //原来是10000
