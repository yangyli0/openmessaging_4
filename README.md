...
### 消费过程
一个TOPIC(QUEUE)文件对应一个<code>List&lt;MappedByteBuffer&gt;</code>(**源自** [出处](https://github.com/kzx1025/Tianchi-OrderDB/blob/master/src/main/java/com/db/table/BuyerOrderTable.java) ,这种方式和ByteBuffer相比是很高效的)订阅了该主题的消费者，从TOPIC(QUEUE)文件里一条一条顺序读完所有消息.
>写在前面: 
